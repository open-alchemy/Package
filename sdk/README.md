...
const employeeSpec = await spec.get({ accessToken, specId: 'employee' });
await spec.createUpdate({
  accessToken,
  specId: 'employee',
  specStr: '<an OpenAlchemy OpenAPI Spec>',
});
const employeeSpec = await spec.delete({ accessToken, specId: 'employee' });
